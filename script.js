const content = {
    en: {
        ...
        "outputs-title": "Inspect the score as image, sound, MIDI and video.",
        "outputs-lead": "PyClef keeps the outputs separate so each result can be reviewed with the right level of detail.",
        "output-clean-badge": "Annotated score",
        "output-clean-title": "Clean view",
        "output-clean-text": "A compact notation overlay for quick visual inspection of pitch names and staff grouping.",
        "output-detailed-badge": "Annotation detail",
        "output-detailed-title": "Detailed mode",
        "output-detailed-text": "The detailed annotation view expands labels with confidence values for closer inspection.",
        ...
        "output-video-title": "Synchronized video",
        "output-video-text": "A cropped animated preview emphasizes active notes so the synchronized MP4 is easier to understand.",
