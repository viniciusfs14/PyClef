const content = {
    en: {
        ...
        "output-detailed-title": "Detailed zoom",
        "output-detailed-text": "A closer crop helps evaluate dense passages, stacked notes and label placement.",
        ...
        "output-video-text": "Use the video preview to follow playback and inspect how the reconstruction moves through the score.",
    ...
    pt: {
        ...
        "output-detailed-title": "Zoom detalhado",
        "output-detailed-text": "Um recorte mais próximo ajuda a avaliar passagens densas, notas empilhadas e posicionamento dos rótulos.",
        ...
        "output-video-text": "Use a prévia em vídeo para acompanhar a reprodução e inspecionar como a reconstrução percorre a partitura.",
